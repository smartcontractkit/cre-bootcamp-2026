...
2. **Crear el directorio de interfaces:**
...
3. **Crear los archivos de interfaz:**
...
4. En la carpeta `contracts`, **Actualiza `foundry.toml` para agregar el remapping de OpenZeppelin:**
```toml
[profile.default]
src = "src"
out = "out"
